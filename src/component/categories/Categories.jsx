  ...
  return (
    <div>
      ...
      <div className="list-item">
        <div className="item">میوه و تره بار
         <img src="/image/felesh2.svg" alt="" />
        </div>
        <div className="item">پروتئین
         <img src="/image/felesh2.svg" alt="" />
        </div>
        <div className="item">لبنیات
         <img src="/image/felesh2.svg" alt="" />
        </div>
        <div className="item">ادویجات
         <img src="/image/felesh2.svg" alt="" />
        </div>
        <div className="item">بار سرد
         <img src="/image/felesh2.svg" alt="" />
        </div>
        <div className="item">بار گرم  
         <img src="/image/felesh2.svg" alt="" />
        </div>
        <div className="item">سوپر مارکتی   
         <img src="/image/felesh2.svg" alt="" />
        </div>
        <div className="item">غیر خوراکی   
         <img src="/image/felesh2.svg" alt="" />
        </div>
      </div>
